...
class WithProductAmastyShopByBrandScope implements Scope
{
    public function apply(Builder $builder, Model $model)
    {
        ...
        $builder
            ...
            ->selectRaw("IF(MAX(amasty_amshopby_option_setting.url_alias) !='', MAX(amasty_amshopby_option_setting.url_alias), REPLACE(REPLACE(".$model->getTable().'.'.$attribute."_value,' ', '_'),'-','_')) as amasty_brand_url")
